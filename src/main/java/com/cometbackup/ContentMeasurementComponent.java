...
public class ContentMeasurementComponent {
	...
	/**
	* @return JSON representation of the ContentMeasurementComponent
	...
	*/
	...
	/**
	* @param jsStr JSON representation of a ContentMeasurementComponent
	* @return The deserialized ContentMeasurementComponent
	* @throws JsonProcessingException If JSON is malformed (should not happen)
	*/
